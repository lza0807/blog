...
import com.lza.blog.utils.ThreadLocalContext;
...
public class RequestAspect {
     ...
     */
    @Pointcut("execution( * com.lza.*.controller..*(..))")
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        String packageException = StringUtils.getPackageException(e, "com.lza");
